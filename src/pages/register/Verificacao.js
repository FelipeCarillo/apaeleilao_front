...
export default function Verificacao() {
    ...
    function enviarEmail(){
        fetch('https://aoltolsszk.execute-api.sa-east-1.amazonaws.com/dev/apae-leilao/send-verification-email-code', {
            method: "GET",
            mode: "cors",
            headers: {
    ...
    async function ValidarEmail(){
        ...
        await fetch("https://aoltolsszk.execute-api.sa-east-1.amazonaws.com/dev/apae-leilao/confirm-verification-email-code", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": localStorage.getItem("token")

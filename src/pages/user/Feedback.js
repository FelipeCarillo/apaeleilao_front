...
export default function Feedback() {
    ...
    return(
        ...
        <main>
                ...
                <section className="border-black mx-[100px] mt-4 box-content h-100 w-2200">
                    <div className="flex flex-col gap-2 text-center">
                        <textarea className=" bg-gray-300 rounded-lg py-6 px-6 mx-72 mb-4 text-2xl" placeholder="Digite aqui..."cols={25}></textarea>
                    </div>
                </section>
                <form className="border-black mx-[100px] text-xl mr-24 mt-4 box-content h-100 w-2200">
                 
                 <label className="block">
                    <div className="flex flex-col gap-2 mx-72 mb-4">
